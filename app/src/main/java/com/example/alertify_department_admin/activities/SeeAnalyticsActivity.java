...
import com.example.alertify_department_admin.databinding.ActivitySeeAnalyticsBinding;
...
public class SeeAnalyticsActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        appSharedPreferences = new AppSharedPreferences(SeeAnalyticsActivity.this);
        getDataFromIntent();
    }
