...
public class CrimeLawsAdp extends RecyclerView.Adapter<CrimeLawsAdp.Holder> {
    ...
    @NonNull
    @Override
    public CrimeLawsAdp.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.crime_laws_recycler_design, parent, false);

        return new CrimeLawsAdp.Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CrimeLawsAdp.Holder holder, int position) {
